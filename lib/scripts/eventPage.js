  ...
  chrome.storage.local.get(['activation', 'blacklist'], result => {
    ...
    chrome.tabs.query({'active': true, 'lastFocusedWindow': true}, (tabs) => {
      ...
      if (blacklistURLs.indexOf(url) === -1) {
        chrome.contextMenus.update('blacklistWebsite', {
          enabled: true
        });
...
chrome.omnibox.onInputChanged.addListener((text, suggest) => {
  ...
  var suggestions = [
    ...
    {
      content:
        'chrome-extension://jaodmdnaglgheeibgdcgdbhljooejiha/views/options.html#/home',
      description: 'Home | Activity',
    },
    {
      content:
        'chrome-extension://jaodmdnaglgheeibgdcgdbhljooejiha/views/options.html#/quiz',
      description:
        'Quiz | Practice your language skills based on real world questions',
    },
    {
      content:
        'chrome-extension://jaodmdnaglgheeibgdcgdbhljooejiha/views/options.html#/translation-settings',
      description: 'Translation Settings',
    },
    {
      content:
        'chrome-extension://jaodmdnaglgheeibgdcgdbhljooejiha/views/options.html#/blacklisting',
      description: 'Blacklist / Whitelist',
    },
    {
      content:
        'chrome-extension://jaodmdnaglgheeibgdcgdbhljooejiha/views/options.html#/learning',
      description: 'Learnt / Saved Translations',
    },
    {
      content:
        'chrome-extension://jaodmdnaglgheeibgdcgdbhljooejiha/views/options.html#/advanced-settings',
      description: 'Advanced Settings',
    },
    {
      content:
        'chrome-extension://jaodmdnaglgheeibgdcgdbhljooejiha/views/options.html#/backup',
      description: 'Backup',
    },
    {
      content:
        'chrome-extension://jaodmdnaglgheeibgdcgdbhljooejiha/views/options.html#/hovercard',
      description: 'Information on Hovercards',
    },
    {
      content:
        'chrome-extension://jaodmdnaglgheeibgdcgdbhljooejiha/views/options.html#/statistics',
