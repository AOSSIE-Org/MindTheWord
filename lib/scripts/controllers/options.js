...
import { QuizzingSentence } from '../services/quizzing';
...
export class OptionCtrl {
  ...
  getData() {
    chrome.storage.local.get(null, (data) => {
      ...
      this.QuizzingSentence = new QuizzingSentence('quiz-sentence-question', this.srcLang, this.targetLang, this.$scope);
      this.$timeout(() => {
        this.$scope.$apply();
      });
      // this.blurCommonWordsButton();
