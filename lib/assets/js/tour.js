...
var tour = new Tour({
    ...
    steps: [
    {
        ...
        content: "This tour will walk you through the extension.",
        onNext: function(){
    ...
    },
    {
        ...
        placement : "right",
        title: "Learnt Words",
        content: "Once you have learnt the translation of a word, you can mark it as learnt. These words will not be translated.",
        onNext: function(){
...

    {
        element: "#backup-nav",
        title: "Backup Tab",
        content: "Use this tab to back-up, restore and delete your configurations and keys.",
        onNext: function(){
    ...
    },
    {
        element: "#quiz-nav",
        title: "Quiz Tab",
        content: "Once you have translated enough words, you will be able to take quizzes and test your knowledge.",
        onNext: function(){
